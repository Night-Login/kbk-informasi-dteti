      ...
      <div className="page-container">
        ...
        <header className="mx-auto max-w-3xl pb-8 pt-7 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-muted">
            Research highlights, achievements, and announcements from the
          ...
          >
            {visibleItems.map((item, index) => {
              const image = getApiAssetUrl(
                item.media?.file_url || item.image_url,
              );
              return (
                <article
                  id={item.slug}
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col p-6">
                      ...
                      <p className="mt-3 line-clamp-5 text-sm leading-6 text-white/90">
                        {item.excerpt}
                      </p>
