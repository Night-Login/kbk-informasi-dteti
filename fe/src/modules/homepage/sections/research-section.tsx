...
function ResearchCard({
  ...
  return (
    ...
    >
      ...
      />
      <span className="absolute inset-x-0 bottom-0 bg-white/92 px-2 py-1.5 text-sm font-extrabold text-ugm-blue">
        {item.title}
      </span>
    </Link>
  );
...
export default function ResearchSection() {
  return (
    <section id="research" className="section-space bg-ugm-blue-soft">
      <div className="page-container grid gap-12 lg:grid-cols-[0.8fr_1.35fr] lg:items-center">
        <div className="max-w-md">
          <h2 className="text-2xl font-extrabold tracking-[-0.02em] text-ugm-blue">
