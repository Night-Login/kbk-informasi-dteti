...
export function DiscoveryFooter({ settings }: { settings: Record<string, string> }) {
  ...
  const social = [ ["Instagram", settings.social_instagram_url || "https://www.instagram.com/dtetiugm/"], ["Facebook", settings.social_facebook_url || "https://web.facebook.com/DTETIFTUGM"], ["YouTube", settings.social_youtube_url] ].filter((item) => item[1]);
